...
class RegistrationUserForm(FlaskForm):
    ...
    authorization = SelectField('Nivo autorizacije', validators=[DataRequired()], choices = [('c_user', 'ZAPOSLENI'),('c_principal', 'NALOGODAVAC'),('c_cashier', 'BLAGAJNIK'),('c_admin', 'ADMIN'),('c_founder', 'OSNIVAČ (bez zaposlenja u pravnom licu)')])
