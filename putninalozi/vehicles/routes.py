...
def vehicle_list():
    ...
    elif current_user.authorization not in ['c_admin', 's_admin', 'c_functionary', 'c_founder']:
...
def register_v():
    if current_user.is_authenticated and (current_user.authorization not in ['c_admin', 's_admin', 'c_functionary', 'c_founder']):
