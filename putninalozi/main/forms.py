...
from wtforms import DecimalField, SubmitField, BooleanField, SelectField
...
class SettingsForm(FlaskForm):
    ...
    default_currency = SelectField('Podrazumevana valuta za dnevnice u državi', choices=[('rsd', 'RSD'), ('€', 'EUR'), ('usd', 'USD')], validators=[DataRequired()])
